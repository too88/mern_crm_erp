...
// SETTING REDUX
export const SETTING_RESET_STATE = 'SETTING_RESET_STATE'
export const SETTING_REQUEST_LOADING = 'SETTING_REQUEST_LOADING'
export const SETTING_REQUEST_SUCCESS = 'SETTING_REQUEST_SUCCESS'
export const SETTING_REQUEST_FAILED = 'SETTING_REQUEST_FAILED'

// TRANSLATE REDUX
export const TRANSLATE_RESET_STATE = "TRANSLATE_RESET_STATE";
export const TRANSLATE_REQUEST_LOADING = "TRANSLATE_REQUEST_LOADING";
export const TRANSLATE_REQUEST_SUCCESS = "TRANSLATE_REQUEST_SUCCESS";
export const TRANSLATE_REQUEST_FAILED = "TRANSLATE_REQUEST_FAILED";
